...
main = do
  io <- mkConc
  zre <- mkZRE "serial"
  nixops <- mkProcCwd "/home/rmarko/ops/base48-cz-configuration" "nixops" ["deploy", "-d", "base48", "--include", "netboot"]
  --fmap print $ runTestConc $ demo io
  --fmap print $ runTest $ dnode zre
  --print $ runTestPure "lol\nyes\n" $ demo io
  --
  fmap print $ runTest $ ops nixops
